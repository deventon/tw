...
function moveMail(name) {
    ...
    if (name == "Scouts") {
        ...
        $('.quickedit-label:contains("späht")').closest(".quickedit.report-title").parent().prev().find('input').prop("checked", true);
    ...
    if (name == "Achievements") {
        ...
        $('.quickedit-label:contains("Erfolg erhalten")').closest(".quickedit.report-title").parent().prev().find('input').prop("checked", true);
    ...
    if (name == "Misc") {
        ...
        $('.quickedit-label:contains("hat ein Skill-Book gefunden")').closest(".quickedit.report-title").parent().prev().find('input').prop("checked", true);
